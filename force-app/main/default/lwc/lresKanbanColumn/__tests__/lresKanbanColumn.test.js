...
describe('c-lres-kanban-column', () => {
    ...
    it('parses drop payload and emits columndrop with record id and keys', () => {
        ...
        dataTransfer.getData = jest.fn(() => JSON.stringify({ recordId: '1', columnKey: 'Source' }));
    ...
    describe('Template Rendering', () => {
        it('renders column label and count correctly', () => {
            ...
            const titleElement = element.shadowRoot.querySelector('.kanban-column_title');
            const countElement = element.shadowRoot.querySelector('.kanban-column_count');
        ...
        it('renders correct number of kanban cards', () => {
            ...
            const cardElements = element.shadowRoot.querySelectorAll('c-lres-kanban-card');
