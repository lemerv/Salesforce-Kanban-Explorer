...
import HierarchyFilterMenu from "c/lresHierarchyFilterMenu";

describe("c-lres-hierarchy-filter-menu", () => {
  afterEach(() => {
  ...
  const buildComponent = (filter) => {
    const element = createElement("c-lres-hierarchy-filter-menu", {
      is: HierarchyFilterMenu
    });
